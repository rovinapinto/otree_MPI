...
class Player(BasePlayer):
    ...
    control_1 = models.IntegerField(label="Wie viele Einheiten verkauft Unternehmen A?")
    control_2 = models.IntegerField(label="Wie viele Einheiten verkauft Unternehmen B?")
    control_3 = models.IntegerField(label="Wie viele Einheiten verkauft Unternehmen C?")
    control_4 = models.IntegerField(label="Wie viele ECU verdient Unternehmen A?")

    def control_1_error_message(self, value):
        print('value is', value)
        if value != 12:
            return 'Bitte überprüfen Sie diese Antwort.'
